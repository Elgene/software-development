...
public class Board {
	...
	/**
	 * Removes entire row
	 * @param y The value of y from the board is to be clear
	 */
	public void clearEntireRow(int y){
	 ...
	 * @param y	 clear the value of y
	 * @param x	clear the value of x
	 */
	public void clearTheCell(int y, int x){
